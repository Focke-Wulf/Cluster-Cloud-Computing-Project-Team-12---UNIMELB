...
# This program serves for the topic of Abbott and refugee
import copy
import json
import time
import re
...
def main():
    ...
    print(suburb_set)
    with open(str(topic_file).rstrip("txt") + "json", 'w') as love:
        json.dump(suburb_set, love)
